    ...
    public List<SalaryCollection> getAllForSalaries(Filter filter) {
        ...
        for (Employee employee : employees) {
            ...
            for (Production production : productions) {
                ...
                salaryDetail.setProductionId(production.getId());
                salaryDetail.setProductionDate(production.getDate());
                salaryDetail.setProductionReference(production.getReference());
                salaryDetail.setWorkedHours(performer.getWorkedHours());
                salaryDetail.setSalary(performer.getSalary());
                salaryDetail.setProduct(productRepository.findById(production.getProductId()));

                salaryCollection.calcOverallSalary(performer.getSalary());
                salaryCollection.setOneDetail(salaryDetail);
            }
...
//        }
    ...
    private SalaryDetail collectSalaryForPerson(List<Production> productions, Employee employee) {
